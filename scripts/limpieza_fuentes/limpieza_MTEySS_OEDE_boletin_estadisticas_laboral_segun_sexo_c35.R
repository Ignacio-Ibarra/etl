...
clean_cuadros_c35 <- function(sheet_name, skip, filas_columnas, names_to, values_to){
...
skip <- 6
filas_columnas <- 4:6
names_to <- c('rama_de_actividad','cod_ciiu','sexo')
values_to <- 'salario_promedio'

df_clean <- clean_cuadros_c35(sheet_name = sheet_name, skip = skip, filas_columnas = filas_columnas, names_to = names_to, values_to = values_to )
...
comparacion <- comparar_fuente_clean(df_clean,
                                     df_clean_anterior ,
                                     pk = c('rama_de_actividad','cod_ciiu','sexo','fecha')
)
