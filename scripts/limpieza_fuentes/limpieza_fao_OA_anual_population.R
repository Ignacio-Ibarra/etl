...
#                      nombre = clean_title,
#                      script = code_name,
#                      descripcion = "Se sacan las observaciones donde el código m49_code no es oficial")
