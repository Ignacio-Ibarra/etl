descargar_fuente("R135C0")

archivo <- "ipc_base2021_ppales_aperturas_empalme_2012_2022.csv"

df <- readxl::read_excel(get_temp_path("R135C0"), skip = 1)
...
# agregar_fuente_clean(id_fuente_raw = 135, path_clean = archivo,
...
#                      script = "scripts/limpieza_fuentes/limpieza_ipcba_ppales_aperturas_empalme_2012_2022_dgec_ba.R")

actualizar_fuente_clean(63)
