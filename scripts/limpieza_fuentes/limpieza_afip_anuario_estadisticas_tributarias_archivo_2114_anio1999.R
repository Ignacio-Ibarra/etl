...
name_cols <- c("actividad_economica", 
               ...
               "Mercado interno#Compras totales",
               "Mercado interno#Compras gravadas",
               "Mercado interno#Compras no gravadas",
               "Importaciones#Compras totales")

sheet_name <- readxl::excel_sheets(ruta_archivo)
cell_range <- "A15:K108"

result <- cleaning_func(ruta = ruta_archivo, 
                        name_cols = name_cols, 
