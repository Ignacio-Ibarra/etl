...
df_ssi <- df_afip_ventas %>% 
  filter(detalle == "Ventas totales", destino_venta == "Total", cod_act %in% c("620","631")) %>% 
  mutate(sector = "Software y Servicios Informáticos") %>% 
