...
# source("scripts/subtopicos/TRANEN/12_produc_electricidad_fuente_mundo_twh.R)"
# source("scripts/subtopicos/TRANEN/13_produc_electricidad_fuente_mundo_twh.R)"
...
# source("scripts/subtopicos/TRANEN/16_identidad_kaya_mundo.R)"
...
# source("scripts/subtopicos/TRANEN/19_intensidad_carbono_electri_mundo.R)"
# source("scripts/subtopicos/TRANEN/2_matriz_prim_mundo_historic.R)"
# source("scripts/subtopicos/TRANEN/3_matriz_prim_mundo_historic.R)"
# source("scripts/subtopicos/TRANEN/4_energia_baja_carbono.R)"
# source("scripts/subtopicos/TRANEN/5_matriz_prim_mundo_historic.R)"
