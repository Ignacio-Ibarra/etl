...
code_name <- '13_ISA_genero-pobreza_it1.R'
subtopico <- 'POBREZ'
output_name <- 'ISA_genero-pobreza_it1.csv'
id_fuente <- 140
...
comparacion <- argendataR::comparar_outputs(
  df_output,
  df_anterior,
  pk = c('year','semester','gender','poverty_line'),
  drop_joined_df = F
)
...
df_output %>%
  argendataR::write_output(
    ...
    aclaraciones = "Tasas de pobreza por género, 2003-2023",
    subtopico = subtopico,
