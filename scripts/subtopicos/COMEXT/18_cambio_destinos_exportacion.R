################################################################################
##                              Dataset: cambio_destinos_exportacion                               ##
################################################################################
...
df_output <- collapsed_data %>% 
  ungroup() %>% 
  select(iso3, location_name_short_en, partner_code, partner_name_short_en, export_value_pca, export_value_pcb) %>% 
  collect()
...
df_output %>%
  argendataR::write_output(directorio = 'data/COMEXT/',
                           ...
                           etiquetas_indicadores = list("export_value_pca" = "% de las exportaciones argentinas al mundo (promedio 1962-1966)",
                                                        "export_value_pcb" = "% de las exportaciones argentinas al mundo (promedio 2017-2021)"),
