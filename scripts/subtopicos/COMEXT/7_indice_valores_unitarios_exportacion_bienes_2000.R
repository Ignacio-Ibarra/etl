...
df_output <- wdi_comext %>% 
  select(time = year, 
         iso3, 
         countryname, 
         exportunitvalueindex_2000 = Indice_valores_unitarios_exportacion_bienes_2000) 
...
df_output %>%
  ...
  argendataR::write_output(
    ...
    etiquetas_indicadores = list("exportunitvalueindex_2000" = "Índice de valores unitarios de la exportación de bienes (2000 = 100)"),
    unidades = list("exportunitvalueindex_2000" = "real")
  )
