...
url <- "https://cdn.produccion.gob.ar/cdn-mineria/Datos-Abiertos-SIACAM/MineriaComparada/MineriaComparaCategoriasOcupacionales.csv"
...
download_filename <- "MineriaComparaCategoriasOcupacionales.csv"

destfile <- glue::glue("{tempdir()}/{download_filename}")

download.file(url, destfile = destfile, mode = "wb")

nombre = "Categorías ocupacionales por rama (en %), promedio 2016-2021. Datos comparados de categorías ocupacionales en los trabajadores por ramas de toda la economía."
...
actualizar_fuente_raw(id_fuente = 277,
                      nombre = nombre,
                      institucion = institucion,
                      fecha_actualizar = fecha_actualizar,
                      path_raw = download_filename,
