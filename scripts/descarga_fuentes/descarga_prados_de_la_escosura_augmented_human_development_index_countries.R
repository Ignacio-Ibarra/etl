...
url <- "https://frdelpino.es/investigacion/wp-content/uploads/2023/02/AHDI_countries_1870-2020-1.xlsx"
...
download_filename <- "AHDI_countries_1870-2020-1.xlsx"

destfile <- glue::glue("{tempdir()}/{download_filename}")

download.file(url, destfile = destfile, mode = "wb")

nombre = "Countries (1870-2020). Augmented human development in the age of globalization. The Economic History Review (2021)"
institucion = "Prados de la Escosura, Leandro"
...
actualizar_fuente_raw(id_fuente = 292,
                      nombre = nombre,
                      institucion = institucion,
                      fecha_actualizar = fecha_actualizar,
                      path_raw = download_filename,
