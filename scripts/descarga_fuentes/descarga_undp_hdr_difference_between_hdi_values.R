...
hdr_indicator <- hdr_indictators[hdr_indictators$code == "diff_hdi_phdi",]
...
# agregar_fuente_raw(nombre = glue::glue("{hdr_indicator$name}. Human Development Report (Revision {current_year})"),
#                    url = url,
...
actualizar_fuente_raw(id_fuente = 290,
                      nombre = nombre,
                      fecha_actualizar = as.character(fecha_actualizar),
                      path_raw = download_filename,
                      script = code_name
